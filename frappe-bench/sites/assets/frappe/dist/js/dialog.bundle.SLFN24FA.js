        ...
        function(results) {
          ...
          if (results.length) {
            for (const v of results) {
              var row = $(
                repl(
                  '<div class="row link-select-row">						<div class="col-md-6 col-xs-4 scrollable-text"">							<b><a href="#">%(name)s</a></b></div>						<div class="col-md-6 col-xs-8 scrollable-text"">							<span class="text-muted">%(values)s</span></div>						</div>',
                  {
                    name: v[0],
...
//# sourceMappingURL=dialog.bundle.SLFN24FA.js.map
